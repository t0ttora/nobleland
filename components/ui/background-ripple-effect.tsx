  ...
  return (
    ...
    >
      <div className="relative h-auto w-auto overflow-hidden">
        {/* Stronger overall fades overlay */}
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 z-[1]"
          style={{
            background:
              "radial-gradient(60% 60% at 0% 0%, rgba(0,0,0,0.5), transparent 60%)," +
              "radial-gradient(60% 60% at 100% 0%, rgba(0,0,0,0.5), transparent 60%)," +
              "radial-gradient(60% 60% at 0% 100%, rgba(0,0,0,0.5), transparent 60%)," +
              "radial-gradient(60% 60% at 100% 100%, rgba(0,0,0,0.5), transparent 60%)," +
              "radial-gradient(48% 40% at 50% 90%, rgba(0,0,0,0.35), transparent 75%)",
          }}
        />
