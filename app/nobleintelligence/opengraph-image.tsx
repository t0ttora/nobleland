    ...
    (
      <div style={{ width, height, display: 'flex', alignItems: 'center', justifyContent: 'center', background: bg, position: 'relative', fontFamily: 'Inter, ui-sans-serif, system-ui, -apple-system' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24, padding: 64 }}>
          ...
          <h1 style={{ fontSize: 72, fontWeight: 800, lineHeight: 1.1, margin: 0, color: fg }}>Predictive, Embedded AI</h1>
          <p style={{ fontSize: 32, margin: 0, color: 'rgba(243,243,243,0.75)', maxWidth: 900 }}>Proactive insights and anomaly detection for the entire supply chain.</p>
        </div>
      </div>
    ),
    { width, height }
